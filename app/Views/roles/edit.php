            ...
            <form method="post" action="<?= site_url('roles/' . $role['id'] . '/update') ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="slug" name="slug" class="form-control" value="<?= old('slug', $role['slug']) ?>" <?= (int) ($role['is_system'] ?? 0) === 1 ? 'readonly' : '' ?> required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="border rounded p-2">
                            <?php foreach (($modules ?? []) as $moduleKey => $module): ?>
                                <?php $checked = in_array($moduleKey, (array) ($roleModules ?? []), true); ?>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary"><?= esc(lang('App.update_role')) ?></button>
